...
public final class PbBlockEntities {
    public static final BlockEntityType<PaintersBlockEntity> PAINTERS_BLOCK = register("painters_block", FabricBlockEntityTypeBuilder.create(PaintersBlockEntity::new, PbBlocks.allBlocks()).build());
